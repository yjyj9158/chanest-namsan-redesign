...
export const hotelData: HotelData = {
  ...
  localGuide: [
    { name: "태극당", category: "cafe" },
    { name: "하우스 커피앤디저트", category: "cafe" },
    { name: "스타벅스 장충라운지R점", category: "cafe" },
    { name: "묵정", category: "dining" },
    { name: "평양면옥 장충본점", category: "dining" },
    { name: "평안도족발집", category: "dining" },
    { name: "장충단공원", category: "sights" },
    { name: "남산골한옥마을", category: "sights" },
    { name: "N서울타워", category: "sights" },
    { name: "남산둘레길", category: "sights" },
  ],
};

export const LOCAL_GUIDE_TABS = [
  { id: "cafe" as const, label: "카페 & 디저트", emoji: "☕" },
  { id: "dining" as const, label: "식사", emoji: "🍽️" },
  { id: "sights" as const, label: "볼거리", emoji: "🏔️" },
];
